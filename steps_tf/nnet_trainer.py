...
#    def evaluation(self, data_gen):

    def train(self, train_gen, cv_gen = None):
        ...
        self.saver.save(self.sess, self.conf['savedir'] + '/model.ckpt')
        print 'model saved to %s' % (self.conf['savedir'] + '/model.ckpt')
