...
class LSTM(object):
  ...
  def make_proto(self, nnet_conf, nnet_proto_file):
    make_nnet_proto.make_lstm_proto(self.input_dim, self.output_dim, nnet_conf, nnet_proto_file)
  ...
  def prep_feed(self, data_gen, params = None):
    ...
    if params is not None:
      feed_dict.update({
                  ...
                  self.keep_in_prob_holder: params.get('keep_in_prob', 1.0),
                  self.keep_out_prob_holder: params.get('keep_out_prob', 1.0)})
